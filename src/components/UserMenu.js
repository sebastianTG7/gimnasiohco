  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white rounded-lg transition-all shadow-lg border-2 border-cyan-500"
      >
      ...
      {/* Menú dropdown */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-gray-900 border-2 border-cyan-500 rounded-xl shadow-2xl overflow-hidden z-50">
          {/* Header del menú */}
          <div className="bg-gradient-to-r from-cyan-600 to-blue-600 p-4 border-b-2 border-cyan-500">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-cyan-100">{userEmail}</p>
              </div>
            </div>
          </div>
          ...
          <div className="py-2">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 text-white hover:bg-cyan-600/20 transition-all text-left"
            >
